...
**Hallazgos incidentales de esta misma revisión, sin resolver, anotados para Fase 7 o una sesión dedicada:**
...
- **`company='Latitud Perfecta, LLC'` del mismo candidato:** no aparece en ningún lado del CV real descargado — parece alucinación genuina del LLM (rechazo correcto, no es un bug), pero no se confirmó de forma exhaustiva contra las 5 páginas completas del documento.
