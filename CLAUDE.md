...
**Calibración fina de layout — New Format completa, Non Template y BD Format pendientes (11 ago 2026):** tras ~10 rondas de ajuste iterativo contra el canon real de Yanina (verificado con conversión a PDF real vía Microsoft Graph, no solo estructura XML), **New Format Resume Template.docx queda calibrado y confirmado por Santiago** — fuente/tamaño por defecto, bullets nativos (guion, no símbolo especial — Wingdings/Symbol se confirmaron invisibles en la conversión de Graph), fecha de cargo en columna derecha real (tab, no paréntesis ni espacios), fecha de subcargo omitida cuando duplica la de la empresa, 2-3 niveles de spacing calibrados con medición de PDF a nivel de glifo (no baseline). **Non Template y BD Format solo tienen las correcciones básicas de fuente/tamaño/spacing genérico — decisión explícita de Santiago: repetir este mismo proceso caso por caso para cada uno, con sus propios CVs canon (Andrea/Aneira para Non Template, Edgeliz/Edward para BD), en otra sesión.** Detalle completo en `seguimiento/bitacora.md` (11 ago).
